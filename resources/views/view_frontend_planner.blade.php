    ...
    <div class="row">
        ...
        <div class="panel panel-default">
        	  ...
        	  <div class="panel-body">
        			<div class="row">
        			    <div class="col-md-4">
        			        {!! Form::input('text','message_name',null, [
                                            'class' => 'form-control',
                                            'placeholder' => 'Name'
                                            ]) !!}
        			    </div>
        			    <div class="col-md-4">
        			        {!! Form::input('text','message_address',null, [
                                            'class' => 'form-control',
                                            'placeholder' => 'Address'
                                            ]) !!}</div>
        			    <div class="col-md-4">
        			        {!! Form::input('email','message_email',null, [
                                            'class' => 'form-control',
                                            'placeholder' => 'Email'
                                            ]) !!}</div>
        			</div>
                    ...
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="project_type_id" id="projectType_id" class="form-control">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="message_description" id="description" placeholder="Description"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="message_budget" id="message_budget" class="form-control">
