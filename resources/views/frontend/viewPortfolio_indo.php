...
<?php 
  $forlength = 0;
    if($work == "software"){$forlength = 0;}
    if($work == "website"){$forlength = 0;}
    if($work == "internet"){$forlength = 0;}
    if($work == "hardware"){$forlength = 0;}
    if($work == "design"){$forlength = 0;}
    if($work == "video"){$forlength = 0;}
  $ctr = 0; 
  $check = 4;
